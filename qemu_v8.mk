...
# Targets
################################################################################
all: arm-tf edk2 qemu soc-term linux strace update_rootfs helloworld fim rsa
clean: arm-tf-clean busybox-clean edk2-clean linux-clean \
	optee-os-clean optee-client-clean qemu-clean \
	soc-term-clean check-clean strace-clean helloworld-clean fim-clean rsa-clean
